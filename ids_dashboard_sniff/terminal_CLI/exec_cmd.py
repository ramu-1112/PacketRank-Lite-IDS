...
class CommandTable:
    def __init__(self):
        self.table = {"blockv4":self.blockv4_cmdCLI,"unblockv4":self.unblockv4_cmdCLI,"blockv6":self.blockv6_cmdCLI,"unblockv6":self.unblockv6_cmdCLI}
    ...
    def start_sniff_cmdCLI(self,func):
        ...
        sniff_cmd.attack_scoring.connect(func)
        sniff_cmd.start()
